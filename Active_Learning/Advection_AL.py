...
# -*- coding: utf-8 -*-
"""
Active Learning of a Neural PDE Surrogate solving the Advection Equation, with newer data points sampled in regions
 where the prediction residuals fail to fall within the coverage bounds provided by CP 
...
dt, dx = sim.dt, sim.dx
# %% 
#Utility Functions for the AL pipeline. 
...
for ii in range(n_iterations):
    ...
    #Numerical Sim over the Rejected Predictions
    params_filtered = params[filtered_sims]
    print(f'{len(params_filtered)} simulations rejected')
