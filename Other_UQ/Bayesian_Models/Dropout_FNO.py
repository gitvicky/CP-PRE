...
class FNO2d(nn.Module):
    def __init__(self, modes1, modes2, vars, width, dropout_rate=0.1):
...
class FNO_multi2d_Dropout(nn.Module):
    def __init__(self, T_in, step, modes1, modes2, num_vars, width_time, dropout_rate=0.1, width_vars=0, grid='arbitrary'):
        super(FNO_multi2d_Dropout, self).__init__()
        ...
        self.f0 = FNO2d(self.modes1, self.modes2, self.num_vars, self.width_time, dropout_rate)
        self.f1 = FNO2d(self.modes1, self.modes2, self.num_vars, self.width_time, dropout_rate)
        self.f2 = FNO2d(self.modes1, self.modes2, self.num_vars, self.width_time, dropout_rate)
        self.f3 = FNO2d(self.modes1, self.modes2, self.num_vars, self.width_time, dropout_rate)
        self.f4 = FNO2d(self.modes1, self.modes2, self.num_vars, self.width_time, dropout_rate)
        self.f5 = FNO2d(self.modes1, self.modes2, self.num_vars, self.width_time, dropout_rate)
    ...
    def forward(self, x):
        ...
        x = self.fc0_time(x)
        x = self.dropout(x)  # Add dropout after initial projection
...
# %%
#Example Usage
model = FNO_multi2d_Dropout(T_in=20, step=5, modes1=8, modes2=8, num_vars=1, width_time=32, width_vars=0, dropout_rate=0.1)
